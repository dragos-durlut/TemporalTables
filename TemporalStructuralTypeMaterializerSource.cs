...
/// <summary>
/// Allows temporal Period properties to be mapped to CLR properties.
/// </summary>
/// <remarks>Copied from EF Core's StructuralTypeMaterializerSource with modifications to handle temporal properties. #35883</remarks>
/// <seealso cref="https://github.com.mcas.ms/dotnet/efcore/blob/v10.0.0/src/EFCore/Query/Internal/StructuralTypeMaterializerSource.cs"/>
/// <see cref="https://github.com/dotnet/efcore/issues/26463"/>
public class TemporalStructuralTypeMaterializerSource : IStructuralTypeMaterializerSource
{
    ...
    public static readonly MethodInfo PopulateListMethod
        = typeof(TemporalStructuralTypeMaterializerSource).GetMethod(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public TemporalStructuralTypeMaterializerSource(Microsoft.EntityFrameworkCore.Query.Internal.StructuralTypeMaterializerSourceDependencies dependencies)
    {
    ...
    /// </summary>
    protected virtual Microsoft.EntityFrameworkCore.Query.Internal.StructuralTypeMaterializerSourceDependencies Dependencies { get; }
        ...
        Expression materializationContextExpression)
    {
        ...
        var materializationExpression = _materializationInterceptor == null
            ...
            ? properties.Count == 0 && blockExpressions.Count == 0
                ...
                : CreateMaterializeExpression(blockExpressions, instanceVariable, constructorExpression, getValueBufferExpression, properties, bindingInfo, temporalPropertiesBlockExpressions)
    ...
    private static void AddAttachServiceExpressions(
        ...
        List<Expression> blockExpressions)
    {
        var materializationContextProperty = typeof(MaterializationContext).GetProperty(nameof(MaterializationContext.Context))!; //this is used to mimick the MaterializationContext.Context property
        var getContext = Property(bindingInfo.MaterializationContextExpression, materializationContextProperty);
